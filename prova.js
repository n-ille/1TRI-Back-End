...
turma = "DS B"
serie = 3
console.log( "olá, meu nome é ", nome, "minha altura é ", altura, "sou da turma ", turma, "e sou da serie ", serie)


const nomesEsporte = ["queimada", "volei", "ping pong"]


if (altura < 1.73) {
console.log("voce e menor que o patrick")
} else {
    console.log("voce e maior que o patrick")
}